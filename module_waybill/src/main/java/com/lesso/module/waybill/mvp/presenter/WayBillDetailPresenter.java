...
public class WayBillDetailPresenter extends BasePresenter<WayBillDetailContract.Model, WayBillDetailContract.ViewI> {
    ...
    @Inject
    public WayBillDetailPresenter(WayBillDetailContract.Model model, WayBillDetailContract.ViewI rootView) {
    ...
    private void getWayBillDetail(String orderId) {
        ...
        mModel.getWayBillDetail(orderId)
                ...
                .subscribe(new MyHttpResultObserver<HttpResult<WayBillDetailBean>>(mErrorHandler) {
                    @Override
