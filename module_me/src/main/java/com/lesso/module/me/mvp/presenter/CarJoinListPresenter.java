 ...
 */
@ActivityScope
public class CarJoinListPresenter
        extends BasePresenter<CarJoinListContract.Model, CarJoinListContract.View> {
    @Inject
    ...
    @Inject
    public CarJoinListPresenter(CarJoinListContract.Model model,
                                CarJoinListContract.View rootView) {
    ...
    public void getCarJoinList(String companyId, int page, int pageSize) {
        mModel.getCarJoinList(new QueryCarJoinReq(DataHelper.getStringSF(mApplication, Constants.SP_USER_ID), companyId, page, pageSize))
        ...
        mModel.joinCar(carJoinReq)
              ...
              .subscribe(new MyHttpResultObserver<HttpResult>(mErrorHandler) {
                  ...
                  public void onResult(HttpResult result) {
                      ...
                      mRootView.showMessage(mApplication.getString(carJoinReq.getMessageId()));
                  }
              });
    }
}
