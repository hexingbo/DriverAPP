...
public class ProgressButton extends AppCompatButton {
    ...
    private int defaultButtonColor = 0xFFF0F0F0;
    private int defaultProgressColor = 0xFFFACA0C;
    private int defaultBackColor = defaultButtonColor;
...
//        int defaultButtonColor = getResources().getColor(R.color.colorGray);
        //Get default progress color
//        int defaultProgressColor = getResources().getColor(R.color.colorGreen);
        //Get default progress background color
//        int defaultBackColor = getResources().getColor(R.color.colorGray);
