...
//        DataHelper.setStringSF(AppManagerUtil.appContext(),Constants.SP_TOKEN, "WbRI290SekZjt3e6VWQVZoHrpXZo17i\/3FxRQCAysr97+p2TAvTimTKQB0nL+Ecyin++pakkI5iNQ3Bg7rUmUgkBdTZ575k1");
        String token = DataHelper.getStringSF(AppManagerUtil.appContext(), Constants.SP_TOKEN);
        String deviceID = DataHelper.getStringSF(AppManagerUtil.appContext(), Constants.SP_DEVICE_ID);
...
//                    .header("Content-Type", "application/json")
                    .header("sign", MD5Util.sign(token + (ArmsUtils.isEmpty(deviceID) ? "android2019" : deviceID) + timestamp, "UTF-8"))
