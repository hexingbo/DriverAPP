...
//        requestWindowFeature(Window.FEATURE_NO_TITLE);
    ...
    private void initTitleBae() {
        rlTitleBar = findViewById(R.id.rl_capturetitlebar);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            FrameLayout.LayoutParams params = (FrameLayout.LayoutParams) rlTitleBar.getLayoutParams();
            Log.v("CaptureActivity","titleBarHeight:"+params.height);
            Log.v("CaptureActivity","StatusBarHeight:"+getStatusBarHeight());
            params.height += getStatusBarHeight();
            Log.v("CaptureActivity","titleBarHeight:"+params.height);
            rlTitleBar.setLayoutParams(params);
            rlTitleBar.setPadding(0, getStatusBarHeight(), 0, 0);
        }
    }
